...
@WebServlet("/farmingSchool/farmingSchoolSearch.do")
public class FarmingSchoolSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/view/cropStory/farmingSchool/farmingSchoolSearchList.jsp");
